		...
		<nav class="navbar top-navbar navbar-expand-md navbar-dark">
		    ...
		    <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
		        ...
		        <ul class="navbar-nav ms-auto d-flex align-items-center">
		            ...
		            %>
		                <form id="searchForm" role="search" class="app-search d-none d-md-block me-3" action="<%=searchAction %>">
		                    <input type="text" placeholder="Search..." class="form-control mt-0" name="searchString">
		                    <a href="#" class="active" onclick="document.getElementById('searchForm').submit()">
